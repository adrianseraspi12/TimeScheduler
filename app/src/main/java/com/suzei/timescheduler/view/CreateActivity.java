...
import com.suzei.timescheduler.viewmodel.CreateScheduleViewModel;
...
public class CreateActivity extends AppCompatActivity {
    ...
    private void setUpViewModel() {
        createScheduleViewModel = ViewModelProviders
                .of(this, viewModelProvider)
                .get(CreateScheduleViewModel.class);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_save) {
            ...
            if (isTimeCorrect()) {
                ...
                createScheduleViewModel.createSchedule(schedule);
